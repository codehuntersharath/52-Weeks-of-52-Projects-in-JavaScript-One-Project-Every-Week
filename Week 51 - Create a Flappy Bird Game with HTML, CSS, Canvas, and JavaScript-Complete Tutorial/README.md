...
# 🐤 Flappy Bird Game — Vanilla JavaScript & HTML5 Canvas
...
A fully playable **Flappy Bird game** built from scratch using **Vanilla JavaScript and HTML5 Canvas**.  
Designed as a **frontend portfolio project** showcasing real game mechanics and animations.
...
[![Watch the video](https://img.youtube.com/vi/O4tsMoHv_tY/maxresdefault.jpg)](https://youtu.be/O4tsMoHv_tY)
...
This project demonstrates real-world JavaScript skills:
- Game loops & animations
- Physics (gravity & jump mechanics)
- Collision detection
- Asset & sound handling
- Canvas rendering
...
## ⚙️ How It Works
- Canvas renders game objects
- Game loop updates positions
- Pipes move dynamically
- Collision triggers game over
- Score updates on pipe pass

...
# ✍️ Live Word & Character Counter (Vanilla JavaScript)
...
A **real-time text analysis tool** built using **Vanilla JavaScript** that counts words, characters, special characters, and estimates reading time — similar to tools used in blogging platforms and editors.
...
[![Watch the video](https://img.youtube.com/vi/QHmzMyMVn-g/maxresdefault.jpg)](https://youtu.be/QHmzMyMVn-g)
...
Text analysis tools are used in:
- Blogging platforms
- SEO editors
- Content writing apps
- Note-taking tools

This project demonstrates **string manipulation, DOM performance, and real-time UI updates**, making it highly valuable for frontend portfolios.
...
## ⚙️ How It Works
1. OTP is generated randomly
2. OTP is auto-sent (simulated)
3. Timer starts for expiration
4. User enters OTP
5. OTP is validated
6. UI updates based on result

---

## ⚙️ How It Works
1. User types text
2. Keyup event triggers analysis
3. Text is processed using JavaScript
4. Counts update instantly in UI
5. Reading time is calculated dynamically
...
- Performance-aware frontend logic

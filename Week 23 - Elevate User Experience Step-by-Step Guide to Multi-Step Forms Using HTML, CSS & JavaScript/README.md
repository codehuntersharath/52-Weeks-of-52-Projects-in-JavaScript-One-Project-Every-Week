...
# Multi-Step Form with Progress Bar – JavaScript Project
...
A **real-world, portfolio-ready Multi-Step Form** built using **HTML, CSS, and Vanilla JavaScript**, featuring smooth animations and a dynamic progress bar.

This project mirrors the type of form flows used in **modern SaaS products and production websites**.
...
[![Watch the video](https://img.youtube.com/vi/O3FfrubyyXw/maxresdefault.jpg)](https://youtu.be/O3FfrubyyXw)
...
Multi-step forms are commonly asked in:
- Frontend interviews
- UI/UX assignments
- Portfolio reviews
...
## ⚙️ How It Works
1. Form is divided into multiple sections
2. JavaScript tracks the active step
3. Progress bar updates dynamically
4. Animations enhance transitions
5. Buttons control navigation flow

---

## 📚 Learning Outcomes
- Build scalable form UI
- Manage multi-step state in JS
- Improve frontend UX

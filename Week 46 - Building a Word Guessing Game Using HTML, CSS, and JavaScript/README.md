...
# Word Guessing Game | JavaScript Project
...
A **Word Guessing Game** built using **HTML, CSS, and Vanilla JavaScript**.

Designed to strengthen **logic building, DOM manipulation, and interactive UI handling** for frontend portfolios.
...
[![Watch the video](https://img.youtube.com/vi/JYVycJ2CXiI/maxresdefault.jpg)](https://youtu.be/JYVycJ2CXiI)
...
- Randomized logic
- User feedback through animations
- Hint-based decision logic

A solid **logic-heavy JavaScript project** for interviews and portfolios.
...
## ⚙️ How It Works
1. Game selects a random word
2. User guesses characters
3. Correct guesses fill blanks
4. Wrong guesses trigger animations
5. Hint can be used once per word
6. Game resets after win

...
# Live Code Editor (CodePen Clone) – JavaScript Project
...
A **real-time Live Code Editor** built using **HTML, CSS, and Vanilla JavaScript**, allowing users to write and execute code instantly in the browser.

This project mirrors the core functionality of tools like **CodePen** and **JSFiddle**.
...
[![Watch the video](https://img.youtube.com/vi/ilzhOlcajMs/maxresdefault.jpg)](https://youtu.be/ilzhOlcajMs)
...
- UI architecture used in developer tools
...
## ⚙️ How It Works
1. User writes code in editors
2. JavaScript captures input events
3. Code is injected into iframe/output
4. Output updates instantly
5. Code is saved in browser storage

---

## 📚 Learning Outcomes
- Build real-time web tools
- Improve JavaScript DOM skills
- Understand browser execution flow

...
# Add to Cart & Shopping Cart – JavaScript E-Commerce Project
...
A **fully functional Add to Cart & Shopping Cart system** built using **HTML, CSS, and Vanilla JavaScript** — no frameworks, no libraries.

This project simulates **real e-commerce cart logic** used in production websites.
...
[![Watch the video](https://img.youtube.com/vi/5j9KITMUfqg/maxresdefault.jpg)](https://youtu.be/5j9KITMUfqg)
...
- Quantity & subtotal calculations
...
- Live subtotal & cart count
- Responsive book shop layout
...
## ⚙️ How It Works
1. Products are generated dynamically
2. Cart state is managed in JavaScript
3. Quantity updates trigger recalculation
4. UI updates instantly via DOM manipulation
5. Responsive styles adapt layout for all screens
...
- Strengthen DOM & event handling skills
- Create portfolio-ready JavaScript projects

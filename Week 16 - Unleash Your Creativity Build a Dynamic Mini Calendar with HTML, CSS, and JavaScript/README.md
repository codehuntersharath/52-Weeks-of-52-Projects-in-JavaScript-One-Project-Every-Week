...
# 📅 Dynamic JavaScript Calendar — Frontend Portfolio Project
...
A **fully dynamic mini / full calendar component** built using **HTML, CSS, and Vanilla JavaScript**.

This project dynamically renders months and years, highlights the current date,  
and provides smooth navigation — perfect for real-world web applications.
...
[![Watch the video](https://img.youtube.com/vi/XiMZsorQIOo/maxresdefault.jpg)](https://youtu.be/XiMZsorQIOo)
...
Calendars are a **common interview & real-world component**.

This project demonstrates:
- Date calculations
- State-driven UI
- Dynamic DOM rendering
- Component-style JavaScript logic

It’s a **strong frontend portfolio piece**, not a basic demo.

---

## ✨ Features
- Dynamic month & year rendering
...
- Determines start & end days of each month
- Dynamically generates calendar cells
- Updates UI on month/year change
- Applies styles based on current date

---

## 📚 Learning Outcomes
- Master JavaScript Date API

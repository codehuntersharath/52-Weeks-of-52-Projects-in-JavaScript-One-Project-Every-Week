...
# 🧮 JavaScript Calculator App (Vanilla JS)
...
A **portfolio-ready Calculator application** built using **Vanilla JavaScript**, focused on logic building, DOM manipulation, and clean UI interactions.

This project is part of **52 Weeks of 52 JavaScript Projects**, designed to strengthen real-world frontend skills.
...
[![Watch the video](https://img.youtube.com/vi/HZc3GyuQjv8/maxresdefault.jpg)](https://youtu.be/HZc3GyuQjv8)
...
This calculator project focuses on **core JavaScript logic**, not just UI:
- Handling dynamic user input
- Implementing arithmetic operations
- Managing application state
- DOM event handling without frameworks

A solid foundational project for:
- Frontend portfolios
- JavaScript interviews
- Beginners learning logic-based development
...
- Inputs are processed as expressions
- Arithmetic logic calculates results
- Output is dynamically rendered to the UI
...
- DOM manipulation
- Writing clean, readable JS code
- Debugging simple logic bugs

...
# ⏰ Digital Clock with Alarm — JavaScript Portfolio Project
...
A **real-time digital clock with alarm functionality** built using **HTML, CSS, and Vanilla JavaScript**.  
Designed as a **logic-focused frontend portfolio project**.
...
[![Watch the video](https://img.youtube.com/vi/vI4iVFobW7k/maxresdefault.jpg)](https://youtu.be/vI4iVFobW7k)
...
This project demonstrates **core frontend logic skills**:
- Time calculations & scheduling
- JavaScript intervals & events
- Alarm validation logic
- Audio playback handling
- UI + logic synchronization

Highly valuable for **interviews and portfolios**.
...
## ⚙️ How It Works
- JavaScript `Date()` fetches live system time
- `setInterval()` updates the UI every second
- Alarm time is compared with current time
- Time difference triggers alarm condition
- Audio plays when alarm matches

---

## 📚 Learning Outcomes
- Working with JavaScript time & dates

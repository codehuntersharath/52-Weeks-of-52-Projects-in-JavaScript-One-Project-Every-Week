...
# Image & Video Search Engine using JavaScript API
...
A **media search engine** built with **HTML, CSS, Vanilla JavaScript, and Pexels API**.

This project allows users to search, preview, and download images & videos — similar to real-world platforms like Unsplash.
...
[![Watch the video](https://img.youtube.com/vi/n8CofTA43NM/maxresdefault.jpg)](https://youtu.be/n8CofTA43NM)
...
This project demonstrates real frontend engineering skills:
- API integration
- Search-driven UI logic
...
## ✨ Features
- Image & video search using API
- Dropdown-based media filtering
- Popup preview for images & videos
- One-click download
...
2. JavaScript sends request to Pexels API
3. Results are fetched asynchronously
4. Media items are rendered dynamically
5. Downloads are handled via direct links

---

## 🎓 Learning Outcomes
- Working with third-party APIs
- Media rendering strategies
- Pagination logic
- UI state handling

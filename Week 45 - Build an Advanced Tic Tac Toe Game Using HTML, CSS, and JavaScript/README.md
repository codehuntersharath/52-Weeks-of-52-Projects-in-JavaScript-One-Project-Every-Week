...
An **advanced Tic Tac Toe game** built using **HTML, CSS, and Vanilla JavaScript**.

This project focuses on **game logic, DOM manipulation, and win/draw detection**, making it ideal for frontend portfolios.
...
[![Watch the video](https://img.youtube.com/vi/_sKV4nx8C_A/maxresdefault.jpg)](https://youtu.be/_sKV4nx8C_A)
...
A strong **logic-focused JavaScript project** for interviews and portfolios.
...
3. Computer selects a random available square
4. Game checks for win or draw

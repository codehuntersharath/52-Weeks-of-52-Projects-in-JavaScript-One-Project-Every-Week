...
# QR Code Generator – JavaScript API Project
...
A **dynamic QR Code Generator** built using **HTML, CSS, and Vanilla JavaScript** that allows users to generate and download QR codes instantly.
...
[![Watch the video](https://img.youtube.com/vi/zDNd5wtC5Yw/maxresdefault.jpg)](https://youtu.be/zDNd5wtC5Yw)
...
This project demonstrates practical frontend skills:
...
2. JavaScript sends data to QR API
3. API returns QR image
4. QR is displayed with animation

...
# Snake Game | JavaScript Canvas Project
...
A **classic Snake Game** built using **HTML, CSS, Canvas, and Vanilla JavaScript**.

This project focuses on **game loops, collision detection, and real-time rendering**, making it a strong **frontend portfolio project**.
...
[![Watch the video](https://img.youtube.com/vi/cMqZxE0E4iE/maxresdefault.jpg)](https://youtu.be/cMqZxE0E4iE)
...
- Keyboard-driven game mechanics
- Collision detection logic
- Real-time game state updates

Highly valuable for **interviews, portfolios, and JavaScript fundamentals**.
...
## ⚙️ How It Works
1. Canvas grid initializes
2. Snake moves based on keyboard input
3. Food spawns randomly on grid
4. Snake grows when food is eaten
5. Collision triggers game over
6. Space key restarts the game

...
# QR Code Reader & Scanner – JavaScript API Project
...
A **QR Code Reader & Scanner** built with **HTML, CSS, and Vanilla JavaScript** that scans QR codes using the **device camera or uploaded images**.
...
[![Watch the video](https://img.youtube.com/vi/O5TMsVxDtXY/maxresdefault.jpg)](https://youtu.be/O5TMsVxDtXY)
...
- Camera access with JavaScript
- Image file handling
- API-based QR decoding
- UI state management
- Clipboard interaction

Ideal for **frontend portfolios and technical interviews**.
...
- Display decoded text instantly
- Copy scanned data
- Smooth animations
- Clean responsive UI
...
## ⚙️ How It Works
1. User uploads an image or enables camera
2. JavaScript captures QR data
3. API decodes the QR content
4. Decoded text is displayed
5. User can copy or close the result

---

## 🎓 Learning Outcomes
- Camera & media access in JavaScript
- File input handling
- API integration

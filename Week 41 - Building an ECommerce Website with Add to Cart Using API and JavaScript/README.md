...
# JavaScript ECommerce Website with Add to Cart
...
A **fully functional eCommerce website** built using **HTML, CSS, Vanilla JavaScript, and API integration**.

This project demonstrates real-world shopping cart logic, product filtering, and dynamic UI updates — ideal for frontend portfolios.
...
This project reflects real frontend challenges:
- API-based product rendering
- Shopping cart logic
- Quantity updates & filtering
- UX-focused UI behavior

Excellent for **interviews & portfolio discussions**.
...
- Quantity updates for same product
...
## ⚙️ How It Works
1. Products are fetched from API on load
2. JavaScript renders product cards dynamically
3. Add to Cart stores selected items by ID
4. Quantity updates handled via state logic
5. Filters refine displayed products
...
- UI/UX logic for eCommerce
- Portfolio-grade JavaScript practices

...
# Dynamic Sidebar Navigation Menu – JavaScript UI Project
...
A **dynamic, collapsible sidebar navigation menu** built using **HTML, CSS, and Vanilla JavaScript** — designed for real dashboards and web apps.
...
[![Watch the video](https://img.youtube.com/vi/z6sUEk9386g/maxresdefault.jpg)](https://youtu.be/z6sUEk9386g)
...
Side navigation menus are a **core UI component** in:
- Admin dashboards
- SaaS products
- Portfolio websites
- Enterprise applications

This project demonstrates **dynamic UI rendering, state handling, and user interaction logic** — not just styling.

---

## ✨ Features
- Dynamic menu generation using JavaScript
- Sub menu support with active states
- Expand / collapse sidebar behavior
- Tooltip UX in collapsed mode
- Responsive layout
...
## ⚙️ How It Works
1. Menu items are defined in a JavaScript object
2. Sidebar UI is generated dynamically
3. Event listeners manage active states & toggles
4. Sub menus open and close based on interaction
5. UI adapts for collapsed and expanded views

---

## 📚 Learning Outcomes
- Build dynamic UI components from data
- Manage UI state without frameworks
- Improve DOM manipulation skills
- Create dashboard-ready navigation logic

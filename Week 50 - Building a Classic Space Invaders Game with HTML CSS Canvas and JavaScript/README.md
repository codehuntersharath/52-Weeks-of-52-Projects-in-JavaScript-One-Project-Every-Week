...
# 👾 Space Invaders Game — Vanilla JavaScript & HTML5 Canvas
...
A fully playable **Space Invaders shooting game** built from scratch using **Vanilla JavaScript and HTML5 Canvas**.  
Designed as a **frontend portfolio project** demonstrating real game logic and rendering.
...
[![Watch the video](https://img.youtube.com/vi/yZV6spBT-mw/maxresdefault.jpg)](https://youtu.be/yZV6spBT-mw)
...
- Enemy invaders with logic
- Bullet collision detection
- Score tracking
- Game over & completion states

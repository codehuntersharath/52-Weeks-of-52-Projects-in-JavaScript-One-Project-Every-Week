...
# 🔐 OTP Generator & Verification System (Vanilla JavaScript)
...
A **frontend authentication project** that demonstrates how One-Time Password (OTP) systems work in real applications — including generation, expiration, and verification logic — built using **Vanilla JavaScript**.
...
[![Watch the video](https://img.youtube.com/vi/MlaePx_0WMQ/maxresdefault.jpg)](https://youtu.be/MlaePx_0WMQ)
...
OTP verification is a critical security layer in:
- Login & signup flows
- Password resets
- Two-factor authentication
- Banking & fintech apps

This project demonstrates **authentication-style logic** that recruiters and interviewers expect frontend developers to understand.

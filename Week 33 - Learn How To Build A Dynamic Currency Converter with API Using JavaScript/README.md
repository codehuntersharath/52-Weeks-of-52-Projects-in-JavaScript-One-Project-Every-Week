...
# Currency Converter – JavaScript API Project
...
A **real-time Currency Converter** built using **HTML, CSS, and Vanilla JavaScript**, powered by live exchange rate APIs.

This project demonstrates how to work with real data and build practical frontend applications.
...
[![Watch the video](https://img.youtube.com/vi/6Kzy-xpRzbI/maxresdefault.jpg)](https://youtu.be/6Kzy-xpRzbI)
...
Great addition to **frontend portfolios and interviews**.
...
## ⚙️ How It Works
1. Fetches country data for currency options  
2. Fetches real-time exchange rates  
3. Updates UI dynamically on input change  
4. Handles swaps and responsive layout  
